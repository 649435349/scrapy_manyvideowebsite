...
class mc_youtube_spider(scrapy.Spider):
    ...
    def start_requests(self):
        if self.choice == 'create':
            # 抓前20页意思意思
            urls = [
                'https://www.youtube.com/results?sp=CAJIAOoDAA%253D%253D&q=%E6%88%91%E7%9A%84%E4%B8%96%E7%95%8C&p={}',
                'https://www.youtube.com/results?sp=CAM%253D&q=%E6%88%91%E7%9A%84%E4%B8%96%E7%95%8C&p={}',
    ...
    def get_now(self, item):
        ...
        mon=d[item.split()[2]]
        return '{}-{}-{}'.format(year, self.change_item(mon), year)